...
import type { CustomerStatement } from '../receivables.service.js';
...
// Mismo layout/paleta que SupplierStatementTemplate en @plexo/payables (y,
// más atrás, VatBookTemplate en @plexo/taxes) - un extracto de cuenta
// corriente es la misma familia de documento en los dos módulos.
...
function CustomerStatementTemplate({
  statement,
  tenantName,
  tenantTaxId,
  generatedAt,
...
export class CustomerStatementPdfService {
  async generate(statement: CustomerStatement): Promise<{ buffer: Buffer; filename: string }> {
    ...
    return { buffer, filename: `cuenta-corriente_${customerSlug}.pdf` };
  }
}
