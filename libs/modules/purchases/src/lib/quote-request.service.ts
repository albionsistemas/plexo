...
export class QuoteRequestService {
  ...
  // autoGenerated es interno - nunca llega vía DTO/HTTP público, sólo lo
  // pasa InventoryReplenishmentSchedulerService (composición en apps/api)
  // al crear sin intervención humana. Default false preserva el
  // comportamiento de cualquier otro caller existente (controller,
  // createGroup) sin tocarlos.
  async create(dto: CreateQuoteRequestDto, autoGenerated = false) {
    const db = getTenantDb();
