...
@Module({
  ...
  controllers: [AdminTenantsController, AdminAuditController, AdminMercadoPagoController],
  providers: [AdminTenantsService, AdminAuditService, AdminMercadoPagoService],
})
