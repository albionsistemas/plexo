  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-semibold text-slate-100">Cuentas a Cobrar</h1>
      ...
      <div className="rounded-xl border border-slate-800 bg-slate-900 p-4">
        <h2 className="mb-4 text-sm font-medium text-slate-400">Antigüedad de saldos</h2>
        {agingQuery.isLoading ? (
          <div className="flex h-32 items-center justify-center text-slate-500">Cargando...</div>
        ) : aging.length === 0 ? (
          <p className="text-sm text-slate-600">Sin saldos pendientes</p>
        ) : (
      ...
      <div className="rounded-xl border border-slate-800 bg-slate-900 p-4">
        <h2 className="mb-4 text-sm font-medium text-slate-400">Saldos y límite de crédito</h2>
              ...
              <tbody>
                {balances.map((row) => (
                  ...
                  >
                    ...
                    <td
                      className={`py-2 pr-4 text-right font-semibold ${Number(row.availableCredit) < 0 ? 'text-red-400' : 'text-green-400'}`}
                    >
